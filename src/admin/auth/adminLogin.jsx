...
export const AdminLoginPage = () => {
  ...
  const header = (
    <img
      alt="Card"
      src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.namesnack.com%2Fimages%2Fnamesnack-clothing-rental-business-names-3840x2560-20200915.jpeg%3Fcrop%3D40%3A21%2Csmart%26width%3D1200%26dpr%3D2%26format%3Dpjpg&f=1&nofb=1"
    />
  );
    ...
    <>
      <div className="login">
        <div className="card-container">
          <Card
            className="sm:col-10 md:col-4 mx-3"
            title="Admin Login"
            footer={footer}
          >
            <div
