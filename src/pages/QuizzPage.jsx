...
export const QuizzPage = () => {
  ...
  const [userQuizzOptions, setUserQuizzOptions] = useState(
    initialStateUserQuizzOptions
  );
      ...
      <>
        <div className=" m-3 field-radiobutton">
          <RadioButton
            ...
            value={genresList}
            onChange={(e) =>
              setUserQuizzOptions((userOptions) => ({
                ...userOptions,
                genre: e.target.value.size,
              }))
            }
  ...
  return (
    <div className="p-4 md:px-8">
      ...
      <div className="grid surface-0 mb-4 shadow-2">
